...
const Empower: React.FC = () => {
  return (
    <div className="uid h-screen w-full bg-oha__green relative overflow-hidden flex justify-between">
      {/* comb 1 */}
      <div className="uid h-full relative flex-shrink-0 w-[560px]">
        <img
          src={comb_frame}
          alt="comb"
      ...
      <div className="absolute w-full z-20 h-full flex justify-center">
        <div className="text-white w-full flex flex-col items-center justify-center gap-6 sm:gap-10">
          <h3 className="text-4xl sm:text-6xl font-semibold tracking-wider text-center">
            Empowering Farmers,
            <br /> One Hive at a Time
          </h3>
          <h4 className="text-lg sm:text-2xl text-center lg:w-[880px] tracking-wider">
