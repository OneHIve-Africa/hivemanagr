  ...
  return (
    <div
      ...
      <div className="flex flex-col justify-center items-center uid gap-10">
        ...
        <p className="text-center text-wrap text-lg leading-8">
          This is more than just a platform—it{"’"}s a movement. A movement
          driven by people like <br /> you who believe in the power of
          collective impact. Whether you{"’"}re an investor seeking <br />{" "}
          meaningful returns, a farmer eager to start a beekeeping journey, or
          an organization <br /> looking to make a difference, One Hive Africa
          welcomes you.
        </p>
